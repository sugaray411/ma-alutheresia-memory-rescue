  ...
  const additionalServices = [
    {
      ...
      description:
        "Education and partnerships to help identify and prevent counterfeit medication use.",
      details:
        "We provide comprehensive education about identifying counterfeit medications and partner with healthcare providers to ensure medication safety.",
    },
    {
      icon: Heart,
      title: "Cardiovascular Health Education",
      description:
        "Awareness, prevention, and education programs focused on heart health and cardiovascular wellness.",
      details:
        "Our cardiovascular programs include education about risk factors, early signs of heart attack, heart failure, hypertension, stroke, and other related conditions, as well as prevention strategies for heart disease, promoting overall cardiovascular wellness through holistic approaches.",
    },
  ];

  // Update image mapping to match the order of memoryServices
  const serviceImages = [
      ...
      <section className="bg-gradient-to-br from-teal-600 via-blue-600 to-purple-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed mb-8">
            Comprehensive, holistic support for memory enhancement, lifestyle
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Cognitive stimulation, physical activity, social interaction, and
              spiritual support
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {memoryServices.map((service, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="hover-lift bg-white border-blue-200/50"
                >
                  ...
                  <CardContent>
                    <div className="w-full h-72 bg-gray-100 rounded mb-4 flex items-center justify-center overflow-hidden border border-gray-200">
                      <img
                        ...
                        style={{
                          display: serviceImages[index] ? "block" : "none",
                          background: "#f3f4f6",
                        }}
                      />
                    </div>
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-emerald-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Nutrition, stress management, exercise, and social support for
              healthier living
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {lifestyleServices.map((service, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="hover-lift bg-white border-green-200/50"
                >
                  <CardHeader className="pb-4">
                    <div className="flex items-center space-x-4">
      ...
      <section className="py-20 bg-gradient-to-br from-purple-50 to-pink-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Specialized programs for medication safety and cardiovascular
              health
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {additionalServices.map((service, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="hover-lift bg-white border-purple-200/50"
                >
                  <CardHeader className="pb-4">
                    <div className="flex items-center space-x-4">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-8 md:p-12 border border-gray-200/50">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              At Ma AluTheresia Memory Rescue and Glitter of Hope Health Inc.,
              we offer complementary non-pharmacological and holistic approaches
              to support memory enhancement and overall wellbeing. Our programs
              are designed to empower individuals through natural methods,
              promoting cognitive health and cardiovascular wellness. However,
              our services are not a substitute for conventional medical
              treatment. We strongly advise consulting a licensed healthcare
              professional before starting any new program, especially if you
              have specific health concerns or questions. Our goal is to
              support, not replace, traditional medical care.
            </p>
          </div>
        </div>
      </section>
